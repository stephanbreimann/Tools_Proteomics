...
"""
from proteomics_tools.perseuspy.per_comput import PerseusComputations
from proteomics_tools.perseuspy.per_plots import PerseusPlots
from proteomics_tools.perseuspy.per_test import PerseusTests
...
class PerseusPipeline(PerseusComputations, PerseusTests, PerseusPlots):    # PerseusNormalization, PerseusImputation,
    ...
    # TODO make get_dict_groups and PerseusPipeline more robust
